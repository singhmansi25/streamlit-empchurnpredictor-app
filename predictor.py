...
def app():
    ...
    with st.form(key="information",clear_on_submit=True):
        ...
        JobSatisfaction = st.selectbox("Choose the level of Job statisfaction of Employee ?", ['1. Low', '2. Medium', '3. High', '4. Very High'])
        ...
        if st.form_submit_button("Predict"):
            ...
            data['JobSatisfaction'] = 1 if data['JobSatisfaction'].iloc[0] == '1. Low' else 2 if data['JobSatisfaction'].iloc[0] == '2. Medium' else 3 if data['JobSatisfaction'].iloc[0] == '3. High' else 4 if data['JobSatisfaction'].iloc[0] == '4. Very High' else 1
